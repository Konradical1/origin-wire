      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
          <div className="relative w-full md:w-1/2 aspect-video rounded-lg overflow-hidden shadow-lg">
            <Image
              src="https://www.nuviewautosalon.com/images/auto-detailing.jpg"
              alt="GH Car Detailing Website"
              fill
            ...
            <div className="absolute bottom-3 left-3 w-24 h-12 md:w-32 md:h-16 opacity-80 pointer-events-none">
              <Image
                src="/images/GH.png"
                alt="GH Car Detailing Logo Overlay"
                fill
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">GH Car Detailing</h1>
            <p className="text-lg text-muted-foreground mb-4">
              A premium mobile car detailing service with online booking and service packages
            </p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            GH Car Detailing needed a professional website that would showcase their mobile detailing services and
            allow customers to book appointments online. The project included service package management, online
            payments, and a modern, user-friendly interface.
          </p>
        </Card>
        <Card className="p-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            ...
            system that handles location-based scheduling and integrates with payment processing for a seamless
            customer experience.
          </p>
        </Card>
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            We created a distinctive brand identity for GH Car Detailing, including a custom logo that reflects
        ...
        <Card className="p-6 md:col-span-2">
          ...
          <p className="text-muted-foreground">
            The new website has significantly improved GH Car Detailing's online presence, making it easier for
            customers to book services and view service packages. The professional design and seamless booking
