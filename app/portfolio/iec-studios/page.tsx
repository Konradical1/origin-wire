      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">IEC Studios</h1>
            <p className="text-lg text-muted-foreground mb-4">
              A creative design studio specializing in branding and digital experiences
            </p>
            <Button asChild size="lg" className="mb-2">
              <Link href="https://iecstudios.com" target="_blank">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            IEC Studios needed a modern portfolio website that would showcase their creative work and services.
            The project included a dynamic portfolio gallery, case studies, and an engaging user interface that
            reflects their creative expertise.
          </p>
        </Card>
        <Card className="p-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            The website was built with a focus on user experience and functionality. We implemented a dynamic
            portfolio system with filtering capabilities and smooth animations to showcase their creative work
            effectively.
          </p>
        </Card>
        <Card className="p-6">
          ...
          <p className="text-muted-foreground">
            We created a distinctive brand identity for IEC Studios, including a custom logo that reflects
            their creative and innovative approach. The design emphasizes creativity and professional expertise.
          </p>
        </Card>
        <Card className="p-6 md:col-span-2">
          ...
          <p className="text-muted-foreground">
            The new website has significantly improved IEC Studios' online presence, making it easier for
            potential clients to view their portfolio and understand their services. The creative design and
            engaging user experience have helped increase client inquiries and showcase their work effectively.
          </p>
        </Card>
      </div>
    </main>
